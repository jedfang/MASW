...
if strcmp(up_low_boundaries,'yes')
    hold on
    obs = plot(c_curve0,lambda_curve0,'ko-','MarkerSize',3,'MarkerFaceColor','k','MarkerEdgeColor','k');
    obs_up = plot(c_curve0_up,lambda_curve0_up,'k+--','MarkerSize',3,'MarkerFaceColor','k','MarkerEdgeColor','k');
    calc = plot(c_t,lambda_t,'r-','MarkerSize',3,'MarkerFaceColor','k','MarkerEdgeColor','k','LineWidth',1.5);
    obs_low = plot(c_curve0_low,lambda_curve0_low,'k+--','MarkerSize',3,'MarkerFaceColor','k','MarkerEdgeColor','k');
